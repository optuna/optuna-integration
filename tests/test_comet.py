...
def test_comet_callback_with_metric_names(
    api_experiment_mock: mock.MagicMock, experiment_mock: mock.MagicMock
) -> None:
    n_trials = 3
...
@mock.patch("comet_ml.Experiment")
@mock.patch("comet_ml.APIExperiment")
def test_comet_callback_initialization(
    api_experiment_mock: mock.MagicMock, experiment_mock: mock.MagicMock
) -> None:
    study = optuna.create_study(direction="minimize")
...
@mock.patch("comet_ml.Experiment")
@mock.patch("comet_ml.APIExperiment")
def test_comet_callback_experiment_key_reuse(
    api_experiment_mock: mock.MagicMock, experiment_mock: mock.MagicMock
) -> None:
    study = optuna.create_study(direction="minimize")
...
@mock.patch("comet_ml.Experiment")
@mock.patch("comet_ml.APIExperiment")
def test_comet_callback_track_in_comet_decorator(
    api_experiment_mock: mock.MagicMock, experiment_mock: mock.MagicMock
) -> None:
    n_trials = 3
...
@mock.patch("comet_ml.Experiment")
@mock.patch("comet_ml.APIExperiment")
def test_best_trials_logged(
    api_experiment_mock: mock.MagicMock, experiment_mock: mock.MagicMock
) -> None:
    n_trials = 5
    study = optuna.create_study(direction="minimize")
    comet_callback = CometCallback(
        study, project_name="best_trials_project", workspace="best_trials_workspace"
    )
