...
|[Trackio](https://optuna-integration.readthedocs.io/en/stable/reference/index.html#trackio)|[TrackioCallback](https://github.com/optuna/optuna-integration/blob/v4.4.0/optuna_integration/trackio/trackio.py#L56-L73)|
